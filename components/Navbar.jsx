...
const Navbar = () => {
	...
	return (
		<>
			<div className="min-w-screen flex justify-between bg-[#182647] h-16 items-center font-bold  shadow-md shadow-slate-300">
			...
			<div
				className={
					activeNav ? 'fixed left-0 top-0 w-full min-h-screen bg-white/60 ' : ''
				}
			>
				<div
					className={
						activeNav
							? 'fixed flex flex-col h-screen justify-between left-0 top-0 w-full bg-black min-h-screen p-10 ease-in duration-500  '
							: 'fixed flex flex-col h-screen justify-between left-[-100%] top-0 min-h-screen p-10 ease-in duration-500  '
					}
				>
